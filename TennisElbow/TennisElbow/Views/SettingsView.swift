    ...
    var body: some View {
        NavigationStack {
            ...
            .confirmationDialog(
                ...
                Text(
                    "This will delete all your scheduled activities, completion history, pain tracking data, and reset the app to its default state. This action cannot be undone."
                )
            }
        }
    }
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text(
                        "The information above is based on guidelines from the American Academy of Orthopaedic Surgeons (AAOS), Mayo Clinic, and peer-reviewed research published in the British Journal of Sports Medicine."
                    )
                    .font(.caption)
                    .foregroundColor(.secondary)
