...
screenshots-iphone-all-languages:
	...
	@$(MAKE) fastlane-run LANE=screenshots_iphone LANE_PARAMS="all_languages:true"
...
screenshots-ipad-all-languages:
	...
	@$(MAKE) fastlane-run LANE=screenshots_ipad LANE_PARAMS="all_languages:true"
